...
import { IconLibraryPhoto, IconArrowRight, IconStar } from '@tabler/icons-react';
...
export function CryptoCard({ user }) {
    ...
    return (
        ...
        >
            <Card className="w-full m-0 overflow-hidden dark:bg-black border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                <motion.div
                ...
                <div className="p-4 w-full">
                    <div className="flex justify-between items-center w-full">
                        <Link to={`/user/${user._id}`} className="flex items-center gap-3 m-2 hover:opacity-90 transition-opacity">
                            <motion.div
                                ...
                                {imgs.map((img, key) => (
                                    ...
                                    >
                                        ...
                                        <motion.div
                                            ...
                                            transition={{ duration: 0.2 }}
                                        >
                                            <p className="text-white text-xs font-medium p-2">Item #{key + 1}</p>
                                        </motion.div>
                                    </motion.div>
                                ))}
                            </motion.div>
